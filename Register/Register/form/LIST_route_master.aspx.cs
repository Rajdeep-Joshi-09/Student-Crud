...
{
    public partial class LIST_route_master : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = BAL_route_master.get_route_details();
        ...
        {
            Response.Redirect("FORM_route_master.aspx");
        }

        protected void grid_route_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "delete_route")
            {
                int id = Convert.ToInt32(e.CommandArgument.ToString());
                int ret_id = BAL_route_master.delete_route_details(id);
                if (ret_id > 0)
                {
                    gridView();
        ...
        protected void btn_edit_Command(object sender, CommandEventArgs e)
        {
            ...
            int edit_id = Convert.ToInt32(grid_route.DataKeys[id].Value);
            string url = "FORM_route_master.aspx?id=" + edit_id;
