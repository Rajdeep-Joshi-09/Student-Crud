...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="flex flex-col items-center gap-3 rounded-lg bg-white shadow-2xl p-8 w-[35%] border border-gray-300">
        ...
        <asp:TextBox runat="server" ID="txtName" placeholder="Enter name" CssClass="border border-gray-300 rounded-lg p-3 w-3/4 focus:ring-2 focus:ring-blue-400"></asp:TextBox>
        ...
        <asp:TextBox runat="server" ID="txtEmail" placeholder="Enter your email" CssClass="border border-gray-300 rounded-lg p-3 w-3/4 focus:ring-2 focus:ring-blue-400"></asp:TextBox>
        <asp:RequiredFieldValidator ID="rv2" runat="server" ControlToValidate="txtEmail" ErrorMessage="Email is required" ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="rv5" runat="server" ControlToValidate="cityList" InitialValue="" ErrorMessage="City is required" ForeColor="Red"></asp:RequiredFieldValidator>

        <asp:TextBox runat="server" ID="txtMobile" placeholder="Enter Contact Info" CssClass="border border-gray-300 rounded-lg p-3 w-3/4 focus:ring-2 focus:ring-blue-400"></asp:TextBox>
        <asp:RequiredFieldValidator ID="rv6" runat="server" ControlToValidate="txtMobile" ErrorMessage="Mobile number is required" ForeColor="Red"></asp:RequiredFieldValidator>
